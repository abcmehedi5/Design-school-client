    ...
    <Slide>
      ...
      >
        ...
        <div className="card-body">
          <h2 className=" text-center text-xl mb-3 font-bold text-slate-700 ">
            {name}
          </h2>
          <div className="card-actions justify-center  mb-4">
            <div className="badge border p-2  flex gap-1 ">
              <TbReportMoney size={20} /> $ {price}
            </div>
            <div className="badge border p-2  flex gap-1">
              {" "}
              <TbArmchair size={16} /> {availableSeats}
            </div>
            <div className="badge border p-2  flex gap-1">
              {" "}
              <BsBookFill size={16} /> {enroll}
            </div>
